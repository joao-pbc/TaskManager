...
const TaskColumn: React.FC<TaskColumnProps> = ({ title, status, tasks, isDragging }) => {
  ...
  return (
    <div className={`${getColumnColor()} rounded-lg shadow-md h-full border border-gray-200 backdrop-blur-sm bg-white/80 flex flex-col transition-colors ${isDragging ? 'ring-2 ring-indigo-300' : ''}`}>
